...
(function () {
	...
	document.addEventListener('DOMContentLoaded', () => {
		...
		console.log(window.location.pathname)
		if (window.location.pathname == '/site/tela_cadastro.html') {
			console.log('dom2')
			//DOM buscando os dados do form de cadastro pelo id
			const dataForm = document.getElementById("registerForm")
			//Event listener esperando o 'submit' do botão para executar
			dataForm.addEventListener('submit', (event) => {
				event.preventDefault()
				console.log('teste')
				...
				if(password !== ConfirmPassword){
					...
					//alerta de confirmação
						...
						window.location.href('/site/tela_cadastro.html')
					}
			})
		}

		console.log(window.location.pathname)
		if (window.location.pathname == '/site/tela_login.html') {
			console.log('dom3')
			//DOM buscando os dados do form de cadastro pelo id
			const dataForm = document.getElementById("loginForm")
			//Event listener esperando o 'submit' do botão para executar
			dataForm.addEventListener('submit', (event) => {
				...
				fetch('http://localhost:3000/userEmail', {
